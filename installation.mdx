...
<Accordion icon="gear" title="TypeScript compilation issues">
  For TypeScript issues: 1. Update to TypeScript 4.5+: `npm install -D typescript@latest` 2. Enable
  `esModuleInterop` and `allowSyntheticDefaultImports` in tsconfig.json 3. Use `import type` for
