...
<ParamField path="webhook" type="WebhookConfig" default="undefined">
  Webhook configuration for receiving transaction status updates. Optional but recommended for production.
