...
<Steps>
  ...
  <Step title="Get Credentials">
    ```bash TOLA_API_KEY=tola_test_your_api_key_here TOLA_MERCHANT_ID=merchant_test_your_id_here ```
  </Step>
</Steps>
...
<Tabs>
  ...
  <Tab title="Bank Transfer">
    - **Minimum:** 10,000 UGX - **Maximum:** 1,000,000,000 UGX (per transaction) - **Daily limit:**
    No limit (with proper authorization) - **Settlement:** T+1 for standard, T+0 for premium
  </Tab>
