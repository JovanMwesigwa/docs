...
<CardGroup cols={3}>
  <Card title="Mobile Money" icon="mobile">
    **Networks:** MTN, Airtel  
    **Currency:** UGX  
    **Features:** Collections, Payouts, Status
  </Card>
  
  <Card title="Bank Transfers" icon="building-columns">
    **Banks:** All major Ugandan banks  
    **Currency:** UGX  
    **Features:** Collections, Payouts, RTGS
  </Card>
  
  <Card title="Card Payments" icon="credit-card">
    **Types:** Visa, Mastercard  
    **Currency:** UGX, USD  
    **Features:** Collections, Refunds
  </Card>
</CardGroup>
...
<Accordion title="Enterprise Onboarding Process">
  1. **Business Assessment** - Detailed business review and requirements analysis
  2. **Compliance Review** - KYC/AML verification and risk assessment (5-10 business days)
  3. **Technical Integration** - Dedicated integration support and testing
  4. **Security Audit** - Comprehensive security and compliance audit
  5. **Go-Live Certification** - Final approval and production access
...
<Tabs>
  <Tab title="Mobile Money">
    - **Minimum:** 500 UGX
    - **Maximum:** 20,000,000 UGX (per transaction)
    - **Daily limit:** 50,000,000 UGX (per merchant)
    - **Monthly limit:** 500,000,000 UGX (per merchant)
  </Tab>
  
  <Tab title="Bank Transfer">
    - **Minimum:** 10,000 UGX
    - **Maximum:** 1,000,000,000 UGX (per transaction)
    - **Daily limit:** No limit (with proper authorization)
    - **Settlement:** T+1 for standard, T+0 for premium
  </Tab>
  
  <Tab title="Card Payments">
    - **Minimum:** 1,000 UGX
    - **Maximum:** 10,000,000 UGX (per transaction)
    - **Daily limit:** 100,000,000 UGX (per merchant)
    - **International:** USD 50,000 equivalent
  </Tab>
</Tabs>
...
app.post('/webhooks/tola/:endpoint', async (req, res) => {
  ...
  const isValid = verifyTolaWebhook(
    payload, 
    signature, 
    timestamp, 
