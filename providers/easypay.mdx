...
<Step title="Create Sandbox App">Click "Create Application" and select "Sandbox Environment"</Step>

<Step title="Get Your Credentials">Copy your Client ID and Secret Key from the dashboard</Step>
...
<Accordion title="Production Onboarding Process">
  1. **Business Registration** - Submit business documents and details 2. **Quick Verification** -
