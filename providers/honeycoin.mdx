...
<CardGroup cols={3}>
  ...
  <Card title="Kenya" icon="flag">
    **Networks:** Safaricom, Airtel **Currency:** KES **Features:** Collections, Payouts, Status
    Check
  </Card>
...
<Steps>
  ...
  <Step title="Set Environment Variables">
    ```bash HONEYCOIN_API_KEY=hc_test_your_api_key_here
...
<Tabs>
  ...
  <Tab title="Kenya (KES)">
    - **Minimum:** 50 KES - **Maximum:** 1,000,000 KES (per transaction) - **Daily limit:**
    2,000,000 KES (per account) - **Monthly limit:** 10,000,000 KES (per account)
  </Tab>
...
<AccordionGroup>
  ...
  <Accordion icon="phone" title="Account Errors">
    **HC_INVALID_PHONE** - Phone number format is incorrect **HC_ACCOUNT_BLOCKED** - Customer
    account is suspended **HC_ACCOUNT_NOT_FOUND** - Phone number not registered
...
<CardGroup cols={2}>
  ...
  <Card title="Webhooks" icon="webhook">
    - [ ] Webhook endpoint secured (HTTPS) - [ ] Signature verification implemented - [ ]
    Idempotency handling added - [ ] Event types handled properly
  </Card>
